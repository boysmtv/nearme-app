    ...
    >
      <div className="relative h-40 bg-gradient-to-br from-primary-100 to-primary-50">
        ...
        <div className="absolute left-3 top-3">
          <span className="inline-block rounded-full bg-white/90 px-2.5 py-1 text-xs font-medium text-primary-700 backdrop-blur-sm">
            {provider.category}
          </span>
        </div>
      </div>
      ...
      <div className="p-4">
        <div className="flex items-start justify-between">
          ...
          {provider.rating > 0 && (
            <div className="flex items-center gap-1 rounded-full bg-primary-50 px-2 py-0.5">
              <svg className="h-3.5 w-3.5 text-primary-500" fill="currentColor" viewBox="0 0 20 20">
