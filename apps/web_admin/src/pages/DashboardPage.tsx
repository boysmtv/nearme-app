...
export default function DashboardPage() {
  ...
  const openCases = (casesRes?.data ?? []).filter((c) => c.status === 'OPEN' || c.status === 'IN_PROGRESS' || c.status === 'WAITING_CUSTOMER');
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            {bookingsLoading ? (
              ...
              <p className="mt-4 text-sm text-red-600">Gagal memuat booking. Coba muat ulang halaman.</p>
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
            ...
            {casesLoading ? (
              ...
              <p className="mt-4 text-sm text-red-600">Gagal memuat kasus. Coba muat ulang halaman.</p>
            ) : openCases.length === 0 ? (
