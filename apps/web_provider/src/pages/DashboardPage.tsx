          ...
          <div className="space-y-6">
            <div className="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
              ...
              <div className="mt-4 space-y-2">
                {[
                  { label: 'Lihat Kalender', href: '/calendar', color: 'text-blue-600 bg-blue-50 hover:bg-blue-100' },
                  { label: 'Kelola Layanan', href: '/services', color: 'text-green-600 bg-green-50 hover:bg-green-100' },
